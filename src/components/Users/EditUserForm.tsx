...
import { useUpdateUserMutation, UserResponse } from "@/redux/feature/user/userApi";
...
export function EditUserForm({ user, onCancel }: EditUserFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // If password is empty, don't send it or send empty string (backend will ignore if empty string or null)
    try {
